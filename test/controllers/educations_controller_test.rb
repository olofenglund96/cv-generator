...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { description: @education.description, school: @education.school, subject: @education.subject } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { description: @education.description, school: @education.school, subject: @education.subject } }
